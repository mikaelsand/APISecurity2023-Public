...
var storageAccountName   = '${toLower(systemIdentifier)}${toLower(uniqueString(systemName, resourceGroup().name, 'func-secure'))}${toLower(env)}'
...
resource authSetting 'Microsoft.Web/sites/config@2021-03-01' = {
